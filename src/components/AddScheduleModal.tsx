...
export default function AddScheduleModal({
    ...
    const selectTimes: Array<{ hour: number; minute: string; text: string }> = generateSelectTimes()
    const colors: typeColor[] = ['red', 'orange', 'yellow', 'green', 'blue']
    ...
    return (
        ...
        shadow-2xl rounded-lg z-50 top-[150px] left-8 m-auto w-[350px] bg-white flex flex-col`}
            >
                ...
                <form className="py-3 px-5 w-full flex flex-col" onSubmit={onSubmitHandle}>
                    <input
                        type="text"
